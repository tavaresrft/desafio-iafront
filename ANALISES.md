...
Para fazer a clusterização dos dados escolhi os métodos KMeans, Mini-Batch-KMeans, BIRCH, AgglomerativeClustering e SpectralClustering, pois eles apresentam uma característica importante que é a escolha da quantidade de clusters gerados, já que dependendo da análise separar os dados em uma quantidade definida de clusters pode ser interessante.
