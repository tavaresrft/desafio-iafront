...
def main(dataset: str, number_of_cluster: int, saida: str, data_inicial, data_final):
    ...
    save_partitioned(dataset, saida+"spectral_clustering_cluster_data_hora", ['cluster_label', 'data', 'hora'])
    save_partitioned(dataset, saida+"spectral_clustering_data_hora_cluster", ['data', 'hora', 'cluster_label'])
    save_partitioned(dataset, saida+"spectral_clustering_data_hora", ['data', 'hora'])
